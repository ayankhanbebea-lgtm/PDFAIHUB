// src/app/cookies/page.tsx — Theme-aware
        ...
        <section className="py-16">
          <div className="section-container max-w-4xl mx-auto">
            <div className="grid grid-cols-1 gap-8">
              ...
              {/* Types of cookies */}
              <div className="bg-card border border-border p-6 sm:p-8 rounded-2xl space-y-6 transition-colors duration-300">
                <h2 className="text-xl font-bold text-foreground flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-primary/10 text-primary border border-primary/25 flex items-center justify-center flex-shrink-0">
                  ...
                  {cookieTypes.map((cookie, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-lg bg-secondary border border-border flex items-center justify-center flex-shrink-0 text-muted-foreground">
                          <Icon className="w-4 h-4" />
                        </div>
                        <div>
                          <h3 className="text-base font-bold text-foreground mb-1">{cookie.title}</h3>
              ...
              <div className="bg-card border border-border p-6 sm:p-8 rounded-2xl space-y-4 transition-colors duration-300">
                ...
                <div className="text-sm text-muted-foreground leading-relaxed pl-12 space-y-3">
                  <p>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><a href="https://support.mozilla.org/kb/enhanced-tracking-protection-firefox-desktop" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Mozilla Firefox</a></li>
                    ...
                    <li><a href="https://support.microsoft.com/microsoft-edge/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Microsoft Edge</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-primary/5 border border-primary/20 p-6 sm:p-8 rounded-2xl text-center space-y-3 transition-colors duration-300">
                <h3 className="text-lg font-bold text-foreground">Questions About Cookie Use?</h3>
